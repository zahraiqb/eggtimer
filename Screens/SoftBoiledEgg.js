...
export default function SoftBoiledEgg({ navigation }) {
  ...
  return (
    ...
    <View style={styles.container}>
      <Text style={styles.title}>Soft Boiled Egg</Text>
      <Image source={require('../assets/egg1.png')} style={styles.image} />
      <Text style={styles.description}>A perfectly runny egg, ideal for dipping toast soldiers!</Text>
